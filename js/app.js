 ...
 */
    ...
    (() => {
        ...
        window.addEventListener("DOMContentLoaded", (() => {
            mixitup(".portfolio__images", {
                selectors: {
                    target: ".portfolio__image"
                },
                animation: {
                    duration: 400,
            ...
            function checkStatus(quantity) {
                if (galleryImages[0].closest(".show-more")) galleryImages.forEach((image => {
                    image.style.display = "block";
                })); else galleryImages.forEach(((image, i) => {
                    if (i >= quantity) image.style.display = "none";
                }));
            }
            ...
            viewMore.addEventListener("click", (e => {
                e.preventDefault();
                viewMore.parentElement.classList.toggle("show-more");
                if (document.body.clientWidth > 767.98) checkStatus(8); else if (document.body.clientWidth > 479.98) checkStatus(6); else if (document.body.clientWidth > 419.98) checkStatus(4); else checkStatus(3);
            }));
            function showImages(quantity, width) {
                if (galleryImages.length > quantity && document.body.clientWidth > width) galleryImages.forEach(((image, i) => {
                    if (i >= quantity) image.style.display = "none";
                }));
            }
            if (document.body.clientWidth > 767.98) showImages(8, 767.98); else if (document.body.clientWidth > 479.98) showImages(6, 479.98); else if (document.body.clientWidth > 419.98) showImages(4, 419.98); else showImages(3, 320);
            if (document.body.clientWidth < 767.98) {
                const parentParagraphBlock = document.querySelector(".about__text");
                const paragraphs = document.querySelectorAll(".about__text p");
                if (paragraphs.length > 1) {
                    ...
                    readMore.classList.add("about__more");
                    parentParagraphBlock.append(readMore);
